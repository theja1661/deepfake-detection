...
# Load datasets
fake_df = pd.read_csv('/home/Project/Deepfake-Detection-Using-Reccurent-Neural-Network/data/Cleaned_Fake.csv')
real_df = pd.read_csv('/home/Project/Deepfake-Detection-Using-Reccurent-Neural-Network/data/Cleaned_Fake.csv')
